# 1 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
# 1 "/home/parag/bl_iot_sdk/customer_app/SWEMS/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
# 37 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
...
# 38 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 2
...
# 39 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 2
# 75 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
static intCallback_Type * irIntCbfArra[IR_INT_ALL]= {
# 75 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 3 4
                                                    ((void *)0)
# 75 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
                                                        ,
# 75 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 3 4
...
# 156 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxInit(IR_TxCfg_Type *irTxCfg)
{
    uint32_t tmpVal;
...
# 193 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxPulseWidthConfig(IR_TxPulseWidthCfg_Type *irTxPulseWidthCfg)
{
    uint32_t tmpVal;
...
# 236 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxSWMPulseWidthConfig(IR_TxSWMPulseWidthCfg_Type *irTxSWMPulseWidthCfg)
{
...
# 259 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_RxInit(IR_RxCfg_Type *irRxCfg)
{
    uint32_t tmpVal;
...
# 310 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_DeInit(void)
{
...
# 325 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Enable(IR_Direction_Type direct)
{
    uint32_t tmpVal;
...
# 355 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Disable(IR_Direction_Type direct)
{
    uint32_t tmpVal;
...
# 385 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxSWM(BL_Fun_Type txSWM)
{
    uint32_t tmpVal;
...
# 408 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_RxFIFOClear(void)
{
    uint32_t tmpVal;
...
# 428 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendData(IR_Word_Type irWord,uint32_t data)
{
...
# 453 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SWMSendData(uint16_t *data,uint8_t length)
{
    uint8_t i = 0,j = 0;
...
# 502 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendCommand(uint32_t word1,uint32_t word0)
{
...
# 547 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SWMSendCommand(uint16_t* data,uint8_t length)
{
    uint32_t timeoutCnt = (100*160*1000);
...
# 591 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendNEC(uint8_t address,uint8_t command)
{
...
# 609 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_IntMask(IR_INT_Type intType,BL_Mask_Type intMask)
{
    uint32_t tmpVal;
...
# 639 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_ClrIntStatus(IR_INT_Type intType)
{
    uint32_t tmpVal;
...
# 670 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Int_Callback_Install(IR_INT_Type intType,intCallback_Type *cbFun)
{
...
# 688 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Sts_Type IR_GetIntStatus(IR_INT_Type intType)
{
    uint32_t tmpVal = 0;
...
# 721 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Sts_Type IR_GetRxFIFOStatus(IR_FifoStatus_Type fifoSts)
{
    uint32_t tmpVal;
...
# 751 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint32_t IR_ReceiveData(IR_Word_Type irWord)
{
    uint32_t tmpVal;
...
# 777 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_SWMReceiveData(uint16_t* data,uint8_t length)
{
    uint8_t rxLen = 0;
...
# 797 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_ReceiveNEC(uint8_t* address,uint8_t* command)
{
...
# 819 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_GetRxDataBitCount(void)
{
    uint32_t tmpVal;
...
# 838 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_GetRxFIFOCount(void)
{
    uint32_t tmpVal;
...
# 858 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
IR_RxMode_Type IR_LearnToInit(uint32_t* data,uint8_t* length)
{
    uint32_t tmpVal;
    uint32_t timeoutCnt = (100*160*1000);
...
# 967 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_LearnToReceive(IR_RxMode_Type mode,uint32_t* data)
{
    uint8_t length = 0;
    uint32_t timeoutCnt = (100*160*1000);
...
# 1026 "/home/parag/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_LearnToSend(IR_RxMode_Type mode,uint32_t* data,uint8_t length)
{
    uint32_t tmpVal;
